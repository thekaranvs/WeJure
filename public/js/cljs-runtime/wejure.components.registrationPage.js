goog.provide('wejure.components.registrationPage');
wejure.components.registrationPage.emptyField = (function wejure$components$registrationPage$emptyField(field){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(cljs.core.deref(field)),(0));
});
wejure.components.registrationPage.emptyPhoto = (function wejure$components$registrationPage$emptyPhoto(photo){
return (cljs.core.deref(photo) == null);
});
wejure.components.registrationPage.is_pwd_matched = (function wejure$components$registrationPage$is_pwd_matched(password,pwdConfirm){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(password),cljs.core.deref(pwdConfirm));
});
wejure.components.registrationPage.step_ref = cljs.core.atom.cljs$core$IFn$_invoke$arity$1("");
wejure.components.registrationPage.loading_ref = cljs.core.atom.cljs$core$IFn$_invoke$arity$1("");
wejure.components.registrationPage.toLoginPage = (function wejure$components$registrationPage$toLoginPage(){
return cljs.core.reset_BANG_(cljs.core.deref(wejure.components.registrationPage.step_ref),(2));
});
goog.exportSymbol('wejure.components.registrationPage.toLoginPage', wejure.components.registrationPage.toLoginPage);
wejure.components.registrationPage.stopLoading = (function wejure$components$registrationPage$stopLoading(){
return cljs.core.reset_BANG_(cljs.core.deref(wejure.components.registrationPage.loading_ref),false);
});
goog.exportSymbol('wejure.components.registrationPage.stopLoading', wejure.components.registrationPage.stopLoading);
wejure.components.registrationPage.submitProfile = (function wejure$components$registrationPage$submitProfile(name,password,photo,details,loading,step){
cljs.core.reset_BANG_(wejure.components.registrationPage.loading_ref,loading);
...
return module$wejure$js$accSystem.register(cljs.core.deref(name),cljs.core.deref(password));
});
wejure.components.registrationPage.registration_page = (function wejure$components$registrationPage$registration_page(p__12039){
var map__12040 = p__12039;
var map__12040__$1 = cljs.core.__destructure_map(map__12040);
var details = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12040__$1,new cljs.core.Keyword(null,"details","details",1956795411));
var step = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12040__$1,new cljs.core.Keyword(null,"step","step",1288888124));
...
cljs.core.reset_BANG_(wejure.components.registrationPage.step_ref,step);
...
}),new cljs.core.Keyword(null,"error","error",-978969032),wejure.components.registrationPage.emptyField(name),new cljs.core.Keyword(null,"helper-text","helper-text",-1920318309),((wejure.components.registrationPage.emptyField(name))?"no text entered (20 characters max)":" "),new cljs.core.Keyword(null,"input-props","input-props",-1504868202),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"max-length","max-length",-254826109),(20)], null)], null)], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"flex-direction","flex-direction",364609438),"column"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.typography.typography,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"variant","variant",-424354234),"h6",new cljs.core.Keyword(null,"component","component",1555936782),"div"], null),"2. Create a password (at least 8 digits)"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.text_field.text_field,new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"variant","variant",-424354234),"filled",new cljs.core.Keyword(null,"type","type",1174270348),"password",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(password),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (e){
return cljs.core.reset_BANG_(password,e.target.value);
}),new cljs.core.Keyword(null,"error","error",-978969032),wejure.components.registrationPage.emptyField(password),new cljs.core.Keyword(null,"helper-text","helper-text",-1920318309),((wejure.components.registrationPage.emptyField(password))?"no text entered (20 characters max)":" "),new cljs.core.Keyword(null,"input-props","input-props",-1504868202),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"max-length","max-length",-254826109),(20)], null)], null)], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"flex-direction","flex-direction",364609438),"column"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.typography.typography,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"variant","variant",-424354234),"h6",new cljs.core.Keyword(null,"component","component",1555936782),"div"], null),"3. Confirm your password"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.text_field.text_field,new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"variant","variant",-424354234),"filled",new cljs.core.Keyword(null,"type","type",1174270348),"password",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(pwdConfirm),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (e){
return cljs.core.reset_BANG_(pwdConfirm,e.target.value);
}),new cljs.core.Keyword(null,"error","error",-978969032),wejure.components.registrationPage.emptyField(pwdConfirm),new cljs.core.Keyword(null,"helper-text","helper-text",-1920318309),((wejure.components.registrationPage.emptyField(pwdConfirm))?"no text entered (20 characters max)":((wejure.components.registrationPage.is_pwd_matched(password,pwdConfirm))?" ":"Passwords do not match")),new cljs.core.Keyword(null,"input-props","input-props",-1504868202),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"max-length","max-length",-254826109),(20)], null)], null)], null)], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"flex-direction","flex-direction",364609438),"column"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.typography.typography,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"variant","variant",-424354234),"h6",new cljs.core.Keyword(null,"component","component",1555936782),"div"], null),"3. Upload a profile picture"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"html-for","html-for",594503920),"upload-image",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin","margin",-995903681),"0 auto"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"accept","accept",1874130431),"image/*",new cljs.core.Keyword(null,"id","id",-1388402092),"upload-image",new cljs.core.Keyword(null,"type","type",1174270348),"file",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"none"], null),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__12038_SHARP_){
var uploaded = (p1__12038_SHARP_.target.files[(0)]);
return cljs.core.reset_BANG_(profilePic,uploaded);
})], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.icon_button.icon_button,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"component","component",1555936782),"span"], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.icons.add_a_photo_sharp.add_a_photo_sharp], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.typography.typography,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"variant","variant",-424354234),"h6",new cljs.core.Keyword(null,"component","component",1555936782),"div",new cljs.core.Keyword(null,"sx","sx",-403071592),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"color","color",1011675173),((wejure.components.registrationPage.emptyPhoto(profilePic))?"#d32f2f":"#070707"),new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"12px",new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),"500",new cljs.core.Keyword(null,"text-align","text-align",1786091845),"center"], null)], null),((wejure.components.registrationPage.emptyPhoto(profilePic))?"no photo uploaded":cljs.core.deref(profilePic).name)], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"flex-direction","flex-direction",364609438),"column",new cljs.core.Keyword(null,"align-items","align-items",-267946462),"center"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.button.button,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"variant","variant",-424354234),"contained",new cljs.core.Keyword(null,"disable-elevation","disable-elevation",-597366875),true,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(function (){var or__5045__auto__ = wejure.components.registrationPage.emptyField(name);
if(or__5045__auto__){
return or__5045__auto__;
} else {
var or__5045__auto____$1 = wejure.components.registrationPage.emptyField(password);
if(or__5045__auto____$1){
return or__5045__auto____$1;
} else {
var or__5045__auto____$2 = wejure.components.registrationPage.emptyPhoto(profilePic);
if(or__5045__auto____$2){
return or__5045__auto____$2;
} else {
var or__5045__auto____$3 = (!(wejure.components.registrationPage.is_pwd_matched(password,pwdConfirm)));
...
return wejure.components.registrationPage.submitProfile(name,password,profilePic,details,loading,step);
...
//# sourceMappingURL=wejure.components.registrationPage.js.map
