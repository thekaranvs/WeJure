...
var G__11905 = o;
reagent.impl.template.goog$module$goog$object.set(G__11905,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__11923__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__11923 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__11924__i = 0, G__11924__a = new Array(arguments.length -  0);
while (G__11924__i < G__11924__a.length) {G__11924__a[G__11924__i] = arguments[G__11924__i + 0]; ++G__11924__i;}
  args = new cljs.core.IndexedSeq(G__11924__a,0,null);
} 
return G__11923__delegate.call(this,args);};
G__11923.cljs$lang$maxFixedArity = 0;
G__11923.cljs$lang$applyTo = (function (arglist__11925){
var args = cljs.core.seq(arglist__11925);
return G__11923__delegate(args);
});
...
var G__11906 = o;
reagent.impl.template.goog$module$goog$object.set(G__11906,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__11926__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__11926 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__11927__i = 0, G__11927__a = new Array(arguments.length -  0);
while (G__11927__i < G__11927__a.length) {G__11927__a[G__11927__i] = arguments[G__11927__i + 0]; ++G__11927__i;}
  args = new cljs.core.IndexedSeq(G__11927__a,0,null);
} 
return G__11926__delegate.call(this,args);};
G__11926.cljs$lang$maxFixedArity = 0;
G__11926.cljs$lang$applyTo = (function (arglist__11928){
var args = cljs.core.seq(arglist__11928);
return G__11926__delegate(args);
});
...
var G__11907 = props;
var G__11907__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11907,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11907);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11907__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__11908 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11908,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__11908;
}
})(),id_class);
...
var G__11909 = (cljs.core.count(argv) - first_child);
switch (G__11909) {
case (0):
...
var vec__11910 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11910,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11910,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11910,(2),null);
...
var temp__5808__auto___11934 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___11934 == null)){
} else {
var key_11936 = temp__5808__auto___11934;
(jsprops.key = key_11936);
}
...
var temp__5808__auto___11937 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___11937 == null)){
} else {
var key_11938 = temp__5808__auto___11937;
(jsprops.key = key_11938);
}
...
var temp__5808__auto___11940 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___11940 == null)){
} else {
var key_11941 = temp__5808__auto___11940;
(jsprops.key = key_11941);
}
...
var temp__5808__auto___11947 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___11947 == null)){
} else {
var key_11948 = temp__5808__auto___11947;
(jsprops.key = key_11948);
}
...
var temp__5808__auto___11951 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___11951 == null)){
} else {
var key_11952 = temp__5808__auto___11951;
(jsprops.key = key_11952);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11913_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__11913_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__11914 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11914,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11914,(1),null);
...
break;
default:
var G__11961 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__11962 = compiler;
v = G__11961;
compiler = G__11962;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template11920 = (function (opts,id,fn_to_element,parse_fn,meta11921){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template11920.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11922,meta11921__$1){
var self__ = this;
var _11922__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template11920(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta11921__$1));
}));

(reagent.impl.template.t_reagent$impl$template11920.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11922){
var self__ = this;
var _11922__$1 = this;
return self__.meta11921;
}));

(reagent.impl.template.t_reagent$impl$template11920.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template11920.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template11920.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template11920.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template11920.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template11920.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta11921","meta11921",490503098,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template11920.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template11920.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template11920");

(reagent.impl.template.t_reagent$impl$template11920.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template11920");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template11920.
 */
reagent.impl.template.__GT_t_reagent$impl$template11920 = (function reagent$impl$template$__GT_t_reagent$impl$template11920(opts,id,fn_to_element,parse_fn,meta11921){
return (new reagent.impl.template.t_reagent$impl$template11920(opts,id,fn_to_element,parse_fn,meta11921));
});
...
return (new reagent.impl.template.t_reagent$impl$template11920(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
