...
1);this.hash=options.hash||options.curve.hash}var BN=require("module$node_modules$bn_DOT_js$lib$bn"),HmacDRBG=require("module$node_modules$hmac_drbg$lib$hmac_drbg");global=require("module$node_modules$elliptic$lib$elliptic$utils");var curves=require("module$node_modules$elliptic$lib$elliptic$curves"),rand=require("module$node_modules$brorand$index"),assert=global.assert,KeyPair=require("module$node_modules$elliptic$lib$elliptic$ec$key"),Signature=require("module$node_modules$elliptic$lib$elliptic$ec$signature");
