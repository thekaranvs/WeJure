...
wejure.components.chatPage.message_list = reagent.core.atom.cljs$core$IFn$_invoke$arity$1("");
...
wejure.components.chatPage.chat_page = (function wejure$components$chatPage$chat_page(p__11885){
var map__11892 = p__11885;
var map__11892__$1 = cljs.core.__destructure_map(map__11892);
var details = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11892__$1,new cljs.core.Keyword(null,"details","details",1956795411));
var step = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11892__$1,new cljs.core.Keyword(null,"step","step",1288888124));
...
})], null),(function (){var iter__5523__auto__ = (function wejure$components$chatPage$chat_page_$_iter__11897(s__11898){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__11900),wejure$components$chatPage$chat_page_$_iter__11897(cljs.core.chunk_rest(s__11898__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__11900),null);
}
} else {
var recipient = cljs.core.first(s__11898__$2);
return cljs.core.cons(((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(recipient,username))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"key","key",-1516042587),recipient,new cljs.core.Keyword(null,"value","value",305978217),recipient], null),recipient], null):null),wejure$components$chatPage$chat_page_$_iter__11897(cljs.core.rest(s__11898__$2)));
}
} else {
return null;
}
