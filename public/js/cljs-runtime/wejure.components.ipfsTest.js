goog.provide('wejure.components.ipfsTest');
wejure.components.ipfsTest.add_file_to_ipfs = (function wejure$components$ipfsTest$add_file_to_ipfs(filename,file_data){
...
wejure.components.ipfsTest.ipfsTest = (function wejure$components$ipfsTest$ipfsTest(){
...
return wejure.components.ipfsTest.add_file_to_ipfs(cljs.core.deref(f).name,cljs.core.deref(f));
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),"file",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__11909_SHARP_){
var v = (p1__11909_SHARP_.target.files[(0)]);
...
//# sourceMappingURL=wejure.components.ipfsTest.js.map
