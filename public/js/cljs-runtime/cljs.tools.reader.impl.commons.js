...
var G__26897 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__26897;
continue;
} else {
return ch;
...
var vec__26870 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26870,(0),null);
return (match === s);
});
...
var G__26906 = (i__4865__auto___26905 + (1));
i__4865__auto___26905 = G__26906;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq26887){
...
return (function() { 
var G__26908__delegate = function (rdr,_){
...
var G__26908 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__26913__i = 0, G__26913__a = new Array(arguments.length -  1);
while (G__26913__i < G__26913__a.length) {G__26913__a[G__26913__i] = arguments[G__26913__i + 1]; ++G__26913__i;}
  _ = new cljs.core.IndexedSeq(G__26913__a,0,null);
} 
return G__26908__delegate.call(this,rdr,_);};
G__26908.cljs$lang$maxFixedArity = 1;
G__26908.cljs$lang$applyTo = (function (arglist__26914){
var rdr = cljs.core.first(arglist__26914);
var _ = cljs.core.rest(arglist__26914);
return G__26908__delegate(rdr,_);
});
