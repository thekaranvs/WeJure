...
require("module$node_modules$keccak$node_modules$readable_stream$lib$internal$streams$stream_browser"),Buffer=require("module$node_modules$buffer$index").Buffer,OurUint8Array=global.Uint8Array||function(){};global=require("module$node_modules$keccak$node_modules$readable_stream$lib$internal$streams$destroy");var getHighWaterMark=require("module$node_modules$keccak$node_modules$readable_stream$lib$internal$streams$state").getHighWaterMark;module=require("module$node_modules$keccak$node_modules$readable_stream$errors").codes;
var ERR_INVALID_ARG_TYPE=module.ERR_INVALID_ARG_TYPE,ERR_METHOD_NOT_IMPLEMENTED=module.ERR_METHOD_NOT_IMPLEMENTED,ERR_MULTIPLE_CALLBACK=module.ERR_MULTIPLE_CALLBACK,ERR_STREAM_CANNOT_PIPE=module.ERR_STREAM_CANNOT_PIPE,ERR_STREAM_DESTROYED=module.ERR_STREAM_DESTROYED,ERR_STREAM_NULL_VALUES=module.ERR_STREAM_NULL_VALUES,ERR_STREAM_WRITE_AFTER_END=module.ERR_STREAM_WRITE_AFTER_END,ERR_UNKNOWN_ENCODING=module.ERR_UNKNOWN_ENCODING,errorOrDestroy=global.errorOrDestroy;require("module$node_modules$inherits$inherits_browser")(Writable,
Stream);WritableState.prototype.getBuffer=function(){for(var current=this.bufferedRequest,out=[];current;)out.push(current),current=current.next;return out};(function(){try{Object.defineProperty(WritableState.prototype,"buffer",{get:internalUtil.deprecate(function(){return this.getBuffer()},"_writableState.buffer is deprecated. Use _writableState.getBuffer instead.","DEP0003")})}catch(_){}})();if("function"===typeof Symbol&&Symbol.hasInstance&&"function"===typeof Function.prototype[Symbol.hasInstance]){var realHasInstance=
Function.prototype[Symbol.hasInstance];Object.defineProperty(Writable,Symbol.hasInstance,{value:function(object){return realHasInstance.call(this,object)?!0:this!==Writable?!1:object&&object._writableState instanceof WritableState}})}else realHasInstance=function(object){return object instanceof this};Writable.prototype.pipe=function(){errorOrDestroy(this,new ERR_STREAM_CANNOT_PIPE)};Writable.prototype.write=function(chunk,encoding,cb$jscomp$0){var state=this._writableState,ret=!1,JSCompiler_temp;
if(JSCompiler_temp=!state.objectMode)JSCompiler_temp=chunk,JSCompiler_temp=Buffer.isBuffer(JSCompiler_temp)||JSCompiler_temp instanceof OurUint8Array;JSCompiler_temp&&!Buffer.isBuffer(chunk)&&(chunk=Buffer.from(chunk));"function"===typeof encoding&&(cb$jscomp$0=encoding,encoding=null);JSCompiler_temp?encoding="buffer":encoding||(encoding=state.defaultEncoding);"function"!==typeof cb$jscomp$0&&(cb$jscomp$0=nop);if(state.ending)state=cb$jscomp$0,cb$jscomp$0=new ERR_STREAM_WRITE_AFTER_END,errorOrDestroy(this,
cb$jscomp$0),process.nextTick(state,cb$jscomp$0);else{var JSCompiler_temp$jscomp$0;if(!(JSCompiler_temp$jscomp$0=JSCompiler_temp)){JSCompiler_temp$jscomp$0=chunk;var cb=cb$jscomp$0,er;null===JSCompiler_temp$jscomp$0?er=new ERR_STREAM_NULL_VALUES:"string"===typeof JSCompiler_temp$jscomp$0||state.objectMode||(er=new ERR_INVALID_ARG_TYPE("chunk",["string","Buffer"],JSCompiler_temp$jscomp$0));er?(errorOrDestroy(this,er),process.nextTick(cb,er),JSCompiler_temp$jscomp$0=!1):JSCompiler_temp$jscomp$0=!0}JSCompiler_temp$jscomp$0&&
(state.pendingcb++,ret=JSCompiler_temp,ret||(er=chunk,state.objectMode||!1===state.decodeStrings||"string"!==typeof er||(er=Buffer.from(er,encoding)),chunk!==er&&(ret=!0,encoding="buffer",chunk=er)),JSCompiler_temp=state.objectMode?1:chunk.length,state.length+=JSCompiler_temp,er=state.length<state.highWaterMark,er||(state.needDrain=!0),state.writing||state.corked?(JSCompiler_temp=state.lastBufferedRequest,state.lastBufferedRequest={chunk,encoding,isBuf:ret,callback:cb$jscomp$0,next:null},JSCompiler_temp?
JSCompiler_temp.next=state.lastBufferedRequest:state.bufferedRequest=state.lastBufferedRequest,state.bufferedRequestCount+=1):doWrite(this,state,!1,JSCompiler_temp,chunk,encoding,cb$jscomp$0),ret=er)}return ret};Writable.prototype.cork=function(){this._writableState.corked++};Writable.prototype.uncork=function(){var state=this._writableState;state.corked&&(state.corked--,state.writing||state.corked||state.bufferProcessing||!state.bufferedRequest||clearBuffer(this,state))};Writable.prototype.setDefaultEncoding=
function(encoding){"string"===typeof encoding&&(encoding=encoding.toLowerCase());if(!(-1<"hex utf8 utf-8 ascii binary base64 ucs2 ucs-2 utf16le utf-16le raw".split(" ").indexOf((encoding+"").toLowerCase())))throw new ERR_UNKNOWN_ENCODING(encoding);this._writableState.defaultEncoding=encoding;return this};Object.defineProperty(Writable.prototype,"writableBuffer",{enumerable:!1,get:function(){return this._writableState&&this._writableState.getBuffer()}});Object.defineProperty(Writable.prototype,"writableHighWaterMark",
{enumerable:!1,get:function(){return this._writableState.highWaterMark}});Writable.prototype._write=function(chunk,encoding,cb){cb(new ERR_METHOD_NOT_IMPLEMENTED("_write()"))};Writable.prototype._writev=null;Writable.prototype.end=function(chunk,encoding,cb){var state=this._writableState;"function"===typeof chunk?(cb=chunk,encoding=chunk=null):"function"===typeof encoding&&(cb=encoding,encoding=null);null!==chunk&&void 0!==chunk&&this.write(chunk,encoding);state.corked&&(state.corked=1,this.uncork());
if(!state.ending){chunk=cb;state.ending=!0;finishMaybe(this,state);if(chunk)if(state.finished)process.nextTick(chunk);else this.once("finish",chunk);state.ended=!0;this.writable=!1}return this};Object.defineProperty(Writable.prototype,"writableLength",{enumerable:!1,get:function(){return this._writableState.length}});Object.defineProperty(Writable.prototype,"destroyed",{enumerable:!1,get:function(){return void 0===this._writableState?!1:this._writableState.destroyed},set:function(value){this._writableState&&
(this._writableState.destroyed=value)}});Writable.prototype.destroy=global.destroy;Writable.prototype._undestroy=global.undestroy;Writable.prototype._destroy=function(err,cb){cb(err)}}
//# sourceMappingURL=module$node_modules$keccak$node_modules$readable_stream$lib$_stream_writable.js.map
