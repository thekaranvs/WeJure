...
var len__5769__auto___13021 = arguments.length;
var i__5770__auto___13022 = (0);
while(true){
if((i__5770__auto___13022 < len__5769__auto___13021)){
args_arr__5794__auto__.push((arguments[i__5770__auto___13022]));

var G__13024 = (i__5770__auto___13022 + (1));
i__5770__auto___13022 = G__13024;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq12945){
var G__12946 = cljs.core.first(seq12945);
var seq12945__$1 = cljs.core.next(seq12945);
var G__12947 = cljs.core.first(seq12945__$1);
var seq12945__$2 = cljs.core.next(seq12945__$1);
var G__12948 = cljs.core.first(seq12945__$2);
var seq12945__$3 = cljs.core.next(seq12945__$2);
var G__12949 = cljs.core.first(seq12945__$3);
var seq12945__$4 = cljs.core.next(seq12945__$3);
var G__12950 = cljs.core.first(seq12945__$4);
var seq12945__$5 = cljs.core.next(seq12945__$4);
var G__12951 = cljs.core.first(seq12945__$5);
var seq12945__$6 = cljs.core.next(seq12945__$5);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12946,G__12947,G__12948,G__12949,G__12950,G__12951,seq12945__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__12989){
var vec__12992 = p__12989;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12992,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12992,(1),null);
