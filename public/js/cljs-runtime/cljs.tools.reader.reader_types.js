...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26671 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26671(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26672 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26672(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26673 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26673(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26677 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26677(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26681 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26681(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26684 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26684(reader);
}
});
...
var G__26717 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26718 = s.append(c);
c = G__26717;
s = G__26718;
continue;
}
