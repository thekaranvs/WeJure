...
while(true){
var vec__20385 = in$;
var seq__20386 = cljs.core.seq(vec__20385);
var first__20387 = cljs.core.first(seq__20386);
var seq__20386__$1 = cljs.core.next(seq__20386);
var k = first__20387;
var rst = seq__20386__$1;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__20388 = show_valid_values_QMARK_;
var G__20389 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__20390 = rst__$1;
return (expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3(G__20388,G__20389,G__20390) : expound.problems.summary_form.call(null,G__20388,G__20389,G__20390));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__20462 = show_valid_values_QMARK_;
var G__20463 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__20464 = rst__$1;
show_valid_values_QMARK_ = G__20462;
form = G__20463;
in$ = G__20464;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__20391 = show_valid_values_QMARK_;
var G__20392 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__20393 = rst__$1;
return (expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3(G__20391,G__20392,G__20393) : expound.problems.summary_form.call(null,G__20391,G__20392,G__20393));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__20394 = show_valid_values_QMARK_;
var G__20395 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__20396 = rst__$1;
return (expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3(G__20394,G__20395,G__20396) : expound.problems.summary_form.call(null,G__20394,G__20395,G__20396));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__20397 = show_valid_values_QMARK_;
var G__20398 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__20399 = rst__$1;
return (expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3(G__20397,G__20398,G__20399) : expound.problems.summary_form.call(null,G__20397,G__20398,G__20399));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__20400 = show_valid_values_QMARK_;
var G__20401 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__20402 = rst__$1;
return (expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3(G__20400,G__20401,G__20402) : expound.problems.summary_form.call(null,G__20400,G__20401,G__20402));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20403_SHARP_){
return cljs.core.count(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__20403_SHARP_));
...
var G__20419 = cljs.core.first(new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(problem));
var fexpr__20418 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ret","ret",-468222814),null], null), null);
return (fexpr__20418.cljs$core$IFn$_invoke$arity$1 ? fexpr__20418.cljs$core$IFn$_invoke$arity$1(G__20419) : fexpr__20418.call(null,G__20419));
}
...
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20447__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20447__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__20448 = opts;
...
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20448__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__20454 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__20455 = false;
cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__20455;
...
}finally {cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__20454;
}})();
var vec__20449 = cljs.core.re_find(regex,s);
var seq__20450 = cljs.core.seq(vec__20449);
var first__20451 = cljs.core.first(seq__20450);
var seq__20450__$1 = cljs.core.next(seq__20450);
var line = first__20451;
var first__20451__$1 = cljs.core.first(seq__20450__$1);
var seq__20450__$2 = cljs.core.next(seq__20450__$1);
var prefix = first__20451__$1;
var _more = seq__20450__$2;
...
var map__20459 = explain_data;
var map__20459__$1 = (((((!((map__20459 == null))))?(((((map__20459.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20459.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20459):map__20459);
var problems = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20459__$1,new cljs.core.Keyword("cljs.spec.alpha","problems","cljs.spec.alpha/problems",447400814));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20459__$1,new cljs.core.Keyword("cljs.spec.alpha","value","cljs.spec.alpha/value",1974786274));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20459__$1,new cljs.core.Keyword("cljs.spec.alpha","args","cljs.spec.alpha/args",1870769783));
var ret = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20459__$1,new cljs.core.Keyword("cljs.spec.alpha","ret","cljs.spec.alpha/ret",1165997503));
var fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20459__$1,new cljs.core.Keyword("cljs.spec.alpha","fn","cljs.spec.alpha/fn",408600443));
var failure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20459__$1,new cljs.core.Keyword("cljs.spec.alpha","failure","cljs.spec.alpha/failure",188258592));
var spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20459__$1,new cljs.core.Keyword("cljs.spec.alpha","spec","cljs.spec.alpha/spec",1947137578));
...
var problems_SINGLEQUOTE_ = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$variadic(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(expound.problems.adjust_in,form),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(expound.problems.adjust_path,failure),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(expound.problems.add_spec,spec),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.partial.cljs$core$IFn$_invoke$arity$2(expound.problems.fix_via,spec),((function (map__20459,map__20459__$1,problems,value,args,ret,fn,failure,spec,caller,form){
return (function (p1__20457_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__20457_SHARP_,new cljs.core.Keyword("expound","form","expound/form",-264680632),form);
});})(map__20459,map__20459__$1,problems,value,args,ret,fn,failure,spec,caller,form))
,((function (map__20459,map__20459__$1,problems,value,args,ret,fn,failure,spec,caller,form){
return (function (p1__20458_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__20458_SHARP_,new cljs.core.Keyword("expound.spec.problem","type","expound.spec.problem/type",-862044659),expound.problems.ptype(failure,p1__20458_SHARP_));
});})(map__20459,map__20459__$1,problems,value,args,ret,fn,failure,spec,caller,form))
], 0)),problems);
