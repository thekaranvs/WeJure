...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__12412 = cljs.core.second(format);
var G__12413 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__12412,G__12413) : ajax.easy.keyword_response_format_element.call(null,G__12412,G__12413));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12421_SHARP_){
return ajax.easy.keyword_response_format_element(p1__12421_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__12436){
var map__12437 = p__12436;
var map__12437__$1 = cljs.core.__destructure_map(map__12437);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12437__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12437__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12437__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__12438){
var vec__12440 = p__12438;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12440,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12440,(1),null);
var fexpr__12445_12463 = (cljs.core.truth_(ok)?h:e);
(fexpr__12445_12463.cljs$core$IFn$_invoke$arity$1 ? fexpr__12445_12463.cljs$core$IFn$_invoke$arity$1(result) : fexpr__12445_12463.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__12446){
var map__12447 = p__12446;
var map__12447__$1 = cljs.core.__destructure_map(map__12447);
var opts = map__12447__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12447__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12447__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12447__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12447__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12447__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
