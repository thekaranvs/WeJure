...
var periods__$1 = cljs.core.vec((function (){var G__12469 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12468_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__12468_SHARP_,(0),(3));
}),G__12469);
} else {
return G__12469;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__12482){
var vec__12483 = p__12482;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12483,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12483,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__12486 = pattern;
switch (G__12486) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12486)].join('')));
...
return p1__12487_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__12488_SHARP_){
return p1__12488_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__12489_SHARP_){
return p1__12489_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__12490_SHARP_){
return p1__12490_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__12491_SHARP_){
return p1__12491_SHARP_.getHours();
});

break;
case "day":
return (function (p1__12492_SHARP_){
return p1__12492_SHARP_.getDate();
});

break;
case "month":
return (function (p1__12493_SHARP_){
return p1__12493_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__12494_SHARP_){
return p1__12494_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12497__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__12501){
var vec__12502 = p__12501;
var seq__12503 = cljs.core.seq(vec__12502);
var first__12504 = cljs.core.first(seq__12503);
var seq__12503__$1 = cljs.core.next(seq__12503);
var key = first__12504;
var args = seq__12503__$1;
var G__12505 = key;
...
break;
case "ordinal-suffix":
var vec__12510 = (function (){var G__12513 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__12513) : syntax_list.call(null,G__12513));
})();
...
var d = value;
var G__12521 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__12523 = G__12521;
var seq__12524 = cljs.core.seq(vec__12523);
var first__12525 = cljs.core.first(seq__12524);
var seq__12524__$1 = cljs.core.next(seq__12524);
var unparser = first__12525;
var more = seq__12524__$1;
var s = "";
var d__$1 = d;
var G__12521__$1 = G__12521;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__12534 = G__12521__$1;
...
var unparser__$1 = first__12536;
var more__$1 = seq__12535__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__12539 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12539,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12539,(1),null);
var G__12593 = d__$3;
var G__12594 = more__$1;
var G__12595 = s__$3;
d__$1 = G__12593;
G__12521__$1 = G__12594;
s__$1 = G__12595;
continue;
}
break;
