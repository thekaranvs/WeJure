...
var i_13370 = (0);
while(true){
if((i_13370 < arr.length)){
(arr[i_13370] = null);

var G__13371 = (i_13370 + (1));
i_13370 = G__13371;
continue;
} else {
}
...
var i_13381 = (self__.level + (1));
while(true){
if((i_13381 <= (new_level + (1)))){
(update[i_13381] = self__.header);

var G__13382 = (i_13381 + (1));
i_13381 = G__13382;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_13383 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13383[i]));
} else {
x__$2.forward.push((((i < links_13383.length))?(links_13383[i]):null));
}

if((i < links_13383.length)){
(links_13383[i] = x__$2);
} else {
links_13383.push(x__$2);
}
...
var i_13391 = (0);
while(true){
if((i_13391 <= self__.level)){
var links_13392 = (update[i_13391]).forward;
if((x__$1 === (((i_13391 < links_13392.length))?(links_13392[i_13391]):null))){
(links_13392[i_13391] = (x__$1.forward[i_13391]));

var G__13395 = (i_13391 + (1));
i_13391 = G__13395;
continue;
} else {
var G__13398 = (i_13391 + (1));
i_13391 = G__13398;
continue;
}
} else {
...
var G__13405 = nx;
var G__13406 = (level__$1 - (1));
x = G__13405;
level__$1 = G__13406;
continue;
} else {
var G__13407 = x;
var G__13408 = (level__$1 - (1));
x = G__13407;
level__$1 = G__13408;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__13410 = nx;
var G__13411 = (level__$1 - (1));
x = G__13410;
level__$1 = G__13411;
continue;
} else {
var G__13412 = x;
var G__13413 = (level__$1 - (1));
x = G__13412;
level__$1 = G__13413;
continue;
}
