...
for(var T=password.run(block1,password.ipad1),U=T,j=1;j<iterations;j++){U=password.run(U,password.ipad2);for(var k=0;k<digest;k++)T[k]^=U[k]}T.copy(DK,destPos);destPos+=digest}return DK}}
