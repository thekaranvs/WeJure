goog.provide('starter.components.loginPage');
starter.components.loginPage.emptyField = (function starter$components$loginPage$emptyField(field){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(cljs.core.deref(field)),(0));
});
starter.components.loginPage.step_ref = cljs.core.atom.cljs$core$IFn$_invoke$arity$1("");
starter.components.loginPage.loading_ref = cljs.core.atom.cljs$core$IFn$_invoke$arity$1("");
starter.components.loginPage.toMainPage = (function starter$components$loginPage$toMainPage(){
return cljs.core.reset_BANG_(cljs.core.deref(starter.components.loginPage.step_ref),(3));
});
goog.exportSymbol('starter.components.loginPage.toMainPage', starter.components.loginPage.toMainPage);
starter.components.loginPage.stopLoading = (function starter$components$loginPage$stopLoading(){
return cljs.core.reset_BANG_(cljs.core.deref(starter.components.loginPage.loading_ref),false);
});
goog.exportSymbol('starter.components.loginPage.stopLoading', starter.components.loginPage.stopLoading);
starter.components.loginPage.authenticate = (function starter$components$loginPage$authenticate(name,password,details,loading,step){
cljs.core.reset_BANG_(starter.components.loginPage.loading_ref,loading);
...
return module$starter$js$accSystem.login(cljs.core.deref(name),cljs.core.deref(password));
});
starter.components.loginPage.loginPage = (function starter$components$loginPage$loginPage(p__12089){
var map__12090 = p__12089;
var map__12090__$1 = cljs.core.__destructure_map(map__12090);
var details = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12090__$1,new cljs.core.Keyword(null,"details","details",1956795411));
var step = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12090__$1,new cljs.core.Keyword(null,"step","step",1288888124));
...
cljs.core.reset_BANG_(starter.components.loginPage.step_ref,step);
...
}),new cljs.core.Keyword(null,"error","error",-978969032),starter.components.loginPage.emptyField(name),new cljs.core.Keyword(null,"helper-text","helper-text",-1920318309),((starter.components.loginPage.emptyField(name))?"no text entered (20 characters max)":" "),new cljs.core.Keyword(null,"input-props","input-props",-1504868202),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"max-length","max-length",-254826109),(20)], null)], null)], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"flex-direction","flex-direction",364609438),"column"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.typography.typography,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"variant","variant",-424354234),"h6",new cljs.core.Keyword(null,"component","component",1555936782),"div"], null),"2. Enter your password"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.text_field.text_field,new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"variant","variant",-424354234),"filled",new cljs.core.Keyword(null,"type","type",1174270348),"password",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(password),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (e){
return cljs.core.reset_BANG_(password,e.target.value);
}),new cljs.core.Keyword(null,"error","error",-978969032),starter.components.loginPage.emptyField(password),new cljs.core.Keyword(null,"helper-text","helper-text",-1920318309),((starter.components.loginPage.emptyField(password))?"no text entered (20 characters max)":" "),new cljs.core.Keyword(null,"input-props","input-props",-1504868202),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"max-length","max-length",-254826109),(20)], null)], null)], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"display","display",242065432),"flex",new cljs.core.Keyword(null,"flex-direction","flex-direction",364609438),"column",new cljs.core.Keyword(null,"align-items","align-items",-267946462),"center"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent_mui.material.button.button,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"variant","variant",-424354234),"contained",new cljs.core.Keyword(null,"disable-elevation","disable-elevation",-597366875),true,new cljs.core.Keyword(null,"disabled","disabled",-1529784218),(function (){var or__5045__auto__ = starter.components.loginPage.emptyField(name);
if(or__5045__auto__){
return or__5045__auto__;
} else {
var or__5045__auto____$1 = starter.components.loginPage.emptyField(password);
...
return starter.components.loginPage.authenticate(name,password,details,loading,step);
...
//# sourceMappingURL=starter.components.loginPage.js.map
